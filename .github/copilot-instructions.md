# GitHub Copilot Instructions for Playwright VS Code Extension

This file provides coding standards and best practices for contributing to the Playwright VS Code extension codebase.
...
- **Unit Tests**: Do not break existing tests; ensure `npm test` passes
- **Build Success**: All code must compile successfully with `npm run build`
